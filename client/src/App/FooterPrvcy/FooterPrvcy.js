        ...
        if (this.state.bannerOn) {
            return (
                <div className="ftr-prvcy">
                    ...
                    <Link to="http://www.google.com/policies/privacy" target="_blank">Google Privacy Policy</Link> and <Link to="https://www.youtube.com/static?template=terms" target="_blank">YouTube Terms of Service</Link>&nbsp;
